package com.june.book.springboot.service.posts;
...
public class PostsService {
    ...
    @Transactional  //readonly 하면 조회속도 개선
    public List<PostsListResponseDto> findAllDesc() {
        return postsRepository.findAllDesc().stream()
                .map(PostsListResponseDto::new) //.map(posts->new PostsListResponseDto(posts)) 와같음
